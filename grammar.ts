...
import type { RecipeGrammarRuleName } from "./grammar/generated/recipe-rule-names.ts";
import {
	COMPOUNDING,
	...
	TIMING_MULTIWORD_RE,
	WARNING,
} from "./grammar/latin/index.ts";
import { UNITS } from "./grammar/units/index.ts";

type RecipeGrammar = GrammarSchema<RecipeGrammarRuleName>;

/** Recipe language tree-sitter grammar definition. */
const recipeGrammar: RecipeGrammar = grammar({
	name: "recipe",
