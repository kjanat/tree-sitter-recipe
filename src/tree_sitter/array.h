...
#define array_grow_by(self, count)                                             \
  do {                                                                         \
    if ((count) == 0)                                                          \
      break;                                                                   \
    (self)->contents =                                                         \
        _array__grow((self)->contents, (self)->size, &(self)->capacity, count, \
...
#define array_extend(self, count, other_contents)                              \
  (self)->contents = _array__splice((void *)(self)->contents, &(self)->size,   \
                                    &(self)->capacity, array_elem_size(self),  \
                                    (self)->size, 0, count, other_contents)
